...
INSTRUCTION = (
    ...
    "user's whole sentence. Search more than once with different phrasings "
    "when the first pass is thin — a filing may call the same thing "
    "'operating income', 'operating profit', or 'income from operations'.\n"
    "3. Use read_document only when you need a full section in order.\n\n"
    "How to answer:\n"
